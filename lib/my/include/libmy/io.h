...
** LibMy - io module
** File description:
** The main header for the io module
*/

/// @file
///
/// Operations for reading and writing to files.
///
/// @since 0.1.0

#ifndef __LIBMY_IO_H__
#define __LIBMY_IO_H__
...
MY_API_BEGIN
    ...
    #error "LibMy: 'libmy/io.h' is included, \
but ascii module is not present"
#endif

#ifndef LIBMY_MODULE_IO
    #error "LibMy: 'libmy/io.h' is included, \
but io module is not present"
#endif
...
/// @returns Always 0.
/// @since 0.1.0
MY_API int my_putuint(unsigned int nb);
...
/// @returns Always 0.
/// @since 0.1.0
MY_API int my_putuint_fd(int fd, unsigned int nb);
...
/// @returns 0 if successful.
/// @since 0.2.0
MY_API int my_fset_buffer(void *buf, size_t buf_cap, void (*free_buf)(void *),
...
///
/// @since 0.1.0
MY_API void my_ffree(my_iostream_t *stream);
...
/// @since 0.1.0
MY_API my_iostream_t *my_get_stdin(void);
...
/// @since 0.1.0
MY_API my_iostream_t *my_get_stdout(void);
...
/// @since 0.1.0
MY_API my_iostream_t *my_get_stderr(void);
...
/// @since 0.2.0
MY_API my_iostream_t *my_get_void_input(void);
...
/// @returns The void stream instance.
/// @since 0.2.0
MY_API my_iostream_t *my_get_void_output(void);
...
///
/// @returns 0, if successful.
MY_API int my_fopen(const char *path, const char *mode, my_iostream_t *stream);
#endif
...
/// @since 0.1.0
MY_API char *my_fread_to_string(
...
/// @since 0.1.0
MY_API size_t my_fputint(int nb, my_iostream_t *stream);
...
///          or 0 if an error occurred.
/// @since 0.2.0
MY_API size_t my_fputintmax_t_base(
...
///          or 0 if an error occurred.
/// @since 0.1.0
MY_API size_t my_fputuint(unsigned int nb, my_iostream_t *stream);
...
///          or 0 if an error occurred.
/// @since 0.2.0
MY_API size_t my_fputuintmax_t_base(
